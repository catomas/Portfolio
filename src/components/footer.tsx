...
export const Footer = ({ footerI18n }: FooterProps) => {
  return (
    <footer className="max-w-3xl pb-36 mx-auto px-4">
      <div className="md:flex md:justify-between">
        <Link href="#home">
          <h4 className="text-2xl sm:text-3xl font-bold my-6 md:my-0">
            JC DEV
          </h4>
        </Link>
        <div className="px-2 flex justify-between md:gap-8 items-center text-xs sm:text-base">
